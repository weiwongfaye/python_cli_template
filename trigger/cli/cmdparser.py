...
from trigger.cli.utils import get_terminal_size
...
def create_parser(command_summaries, parser_kw, general_group=cmdoptions.general_group):
...
def parse_opts(args, command_summaries, parser_kw, general_group):
    main_parser = create_parser(command_summaries, parser_kw, general_group)
